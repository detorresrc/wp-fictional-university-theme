...
<div class="full-width-split group">
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            <h2 class="headline headline--small-plus t-center">Awards</h2>
            <?PHP
            ...
            <?PHP endwhile;
            wp_reset_postdata(); ?>
            <p class="t-center no-margin"><a href="<?= site_url('/category/awards') ?>" class="btn btn--yellow">View All Awards</a></p>
        </div>
    </div>
</div>
